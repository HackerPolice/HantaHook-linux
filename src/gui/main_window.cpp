...
void Gui::render_main_window(){
	...
	size = ImVec2((size.x - 960) / 2, (size.y - 645) / 2);

	ImGui::SetNextWindowPos(ImVec2(size.x, size.y), ImGuiCond_Once);
	ImGui::SetNextWindowSize(ImVec2(960, 645), ImGuiCond_Once);

	ImGui::SetNextWindowBgAlpha(0.0f);
	if (ImGui::Begin(XORSTR("##MissedIt-AimWare-Menu"), (bool*) true,
...
static void BgDecorations()
{
	...
	draw->AddText(info, 13.f, ImVec2(pos.x + 100, pos.y + 625), ImColor(255, 255, 255),
